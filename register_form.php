						...
						<!-- /Billing Details -->
								...
								<form id="signup_form" onsubmit="return false" class="login100-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="input form-control input-borders" type="text" name="l_name" id="l_name" placeholder="Họ và tên lót">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="text-pad">
                                    <a href="" data-toggle="modal" data-target="#Modal_login">Bạn sẵn sàng tạo tài khoản chưa ? Sau đó đăng nhập</a>
